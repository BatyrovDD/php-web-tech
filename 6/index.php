...
<tr> 
 ...
 <th> Редактировать </th>
 <? if ($_SESSION['type'] == 2) { echo '<th> Удалить </th>';} ?> 
 </tr>
<?php
...
if ($_SESSION['type'] == 2) { echo '<p> <a href="new_user.php"> Добавить пользователя </a>'; }
if ($_SESSION['type'] == 2) { echo '<p> <a href="edit_user.php"> Изменить данные пользователя </a>'; }
